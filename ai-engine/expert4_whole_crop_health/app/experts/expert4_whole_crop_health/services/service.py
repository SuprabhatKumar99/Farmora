...
from app.experts.expert4_whole_crop_health.preprocessing.image import (
    ImagePreprocessor,
)
from app.experts.expert4_whole_crop_health.schemas.models import (
    ...
    ModelTask,
    WholeCropDetection,
    WholeCropHealthResult,
)


class Expert4WholeCropHealthService:
    """Expert 4 orchestration.

    Produces whole-crop-health evidence from the supplied model. It does not
    make the final agricultural decision or treatment recommendation.
    """
